            ...
            document.addEventListener('componentsLoaded', {
                "FerramentaIrritacao.useEffect": ()=>{
                    ...
                    function renderQuestionsAsCarousel() {
                        ...
                        questions.forEach({
                            "FerramentaIrritacao.useEffect.renderQuestionsAsCarousel": (q, index)=>{
                    ...
                    `;
                        ...
                        }["FerramentaIrritacao.useEffect.renderQuestionsAsCarousel"]);
                    }
                    ...
                    document.body.addEventListener('input', {
                        "FerramentaIrritacao.useEffect": (e)=>{
                    ...
                    document.body.addEventListener('click', {
                        "FerramentaIrritacao.useEffect": (e)=>{
                            ...
                            if (target.id === 'goto-step2-btn') {
                                ...
                                questions.forEach({
                                    "FerramentaIrritacao.useEffect": (q)=>{
                            ...
                            if (target.id === 'goto-step3-btn') {
                                ...
                                const total = Object.values(scores).reduce({
                                    "FerramentaIrritacao.useEffect.total": (a, b)=>a + b
                                }["FerramentaIrritacao.useEffect.total"], 0);
                                const sortedScores = Object.entries(scores).sort({
                                    "FerramentaIrritacao.useEffect.sortedScores": ([, a], [, b])=>b - a
                                }["FerramentaIrritacao.useEffect.sortedScores"]);
                                const topGatilho = sortedScores[0][0];
                                const topScore = sortedScores[0][1];
                                const scoreClass = {
                                    "FerramentaIrritacao.useEffect.scoreClass": (score)=>score >= 9 ? 'Alto' : score >= 5 ? 'Moderado' : 'Baixo'
                                }["FerramentaIrritacao.useEffect.scoreClass"];
                            ...
                            if (target.id === 'send-report-btn') {
                                ...
                                }["FerramentaIrritacao.useEffect"]).catch({
                                    "FerramentaIrritacao.useEffect": (error)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Modals, {}, void 0, false, {
                    fileName: "[project]/pages/irritacao/index.js",
                    lineNumber: 265,
                    columnNumber: 17
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Copyright, {}, void 0, false, {
                    fileName: "[project]/pages/irritacao/index.js",
                    lineNumber: 266,
                    columnNumber: 17
                }, this)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a21d4690._.js.map